...
import com.ustb.shellchain.command.builders.QueryBuilderRAWTransaction;
import com.ustb.shellchain.object.*;
import com.ustb.shellchain.object.formatters.RAWTransactionFormatter;
import com.ustb.shellchain.object.queryobjects.RawParam;
import com.ustb.shellchain.object.queryobjects.TxIdVout;
...
public class RAWTransactionCommand extends QueryBuilderRAWTransaction {
	 ...
	 */
	public String appendRawChange(String hexString, String address) throws ShellChainException {
	...
	public String appendRawChange(String hexString, Address address) throws ShellChainException {
		if (address == null) {
			throw new ShellChainException("address", "is null");
		}
	 ...
	 * @throws ShellChainException
	 */
	public String appendRawMetaData(String txHex, String dataHex) throws ShellChainException {
	 ...
	 * "hex" (string) The transaction hash in hex (if action= "send")
	 */
	public String createRawSendFrom(String address, List<RawParam> rawParams, String[] data) throws ShellChainException {
	 ...
	 * "hex" (string) The transaction hash in hex (if action= "send")
	 */
	public String createRawSendFrom(String address, List<RawParam> rawParams) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TransactionRAW decodeRawTransaction(String hex) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String getRawChangeAddress() throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TransactionRawDetail getRawTransaction(String txid, int verbose) throws ShellChainException {
		Object objectTransactionRAW = executeGetRawTransaction(txid, verbose);
		TransactionRawDetail result = RAWTransactionFormatter.formatTransactionRawDetail(objectTransactionRAW);
		return result;
	}

	public TransactionRawDetail getRawTransactionTypes(String txid, int verbose) throws ShellChainException {
		Object objectTransactionRAW = executeGetRawTransaction(txid, verbose);
		TransactionRawDetail result = RAWTransactionFormatter.formatTransactionTypes(objectTransactionRAW);
		return result;
	}

	public Map<String,Object> getRawTransactionMap(String txid, int verbose) throws ShellChainException {
		Object objectTransactionRAW = executeGetRawTransaction(txid, verbose);
		Map<String,Object> result = RAWTransactionFormatter.formatTransactionMap(objectTransactionRAW);
		return result;
	}
	 ...
	 * @throws ShellChainException
	 */
	public TransactionRawDetail getRAWTransactionWithDetail(String txid) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TransactionRawDetail getRAWTransactionWithoutDetail(String txid) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public Object sendRawTransaction(String hexString) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public SignedTransactionRAW signRawTransaction(String hexString) throws ShellChainException {
		SignedTransactionRAW signedTransactionRAW = new SignedTransactionRAW();
