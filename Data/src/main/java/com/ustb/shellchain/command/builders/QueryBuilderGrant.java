...
public class QueryBuilderGrant extends QueryBuilderCommon {
	 ...
	 * 
	 * Arguments: 1. "address(es)" (string, required) The shellchain addresses to
	 ...
	 */
	protected Object executeGrant(String address, int permissions) throws ShellChainException {
		String permissionsFormated = formatPermissionsList(permissions);

		ShellChainTestParameter.isNotNullOrEmpty("address", address);
		ShellChainTestParameter.isNotNullOrEmpty("permissionsFormated", permissionsFormated);
	 ...
	 * "to-address(es)" (string, required) The shellchain addresses to grant
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGrantFrom(String addressFrom, String address, int permissions) throws ShellChainException {
		String permissionsFormated = formatPermissionsList(permissions);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGrantWrite(String address, String streamName) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("address", address);
		ShellChainTestParameter.isNotNullOrEmpty("stream", streamName);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGrantWriteFrom(String addressFrom, String address, String streamName) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("addressFrom", addressFrom);
		ShellChainTestParameter.isNotNullOrEmpty("address", address);
		ShellChainTestParameter.isNotNullOrEmpty("stream", streamName);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeRevoke(String address, int permissions) throws ShellChainException {
		String permissionsFormated = formatPermissionsList(permissions);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeRevokeFrom(String addressFrom, String address, int permissions) throws ShellChainException {
		String permissionsFormated = formatPermissionsList(permissions);
