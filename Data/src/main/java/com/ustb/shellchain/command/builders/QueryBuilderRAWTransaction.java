...
import com.ustb.shellchain.object.AddressBalanceAsset;
...
public class QueryBuilderRAWTransaction extends QueryBuilderCommon {
	 ...
	 */
	protected Object executeAppendRawChange(String hexString, String address) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("hexString", hexString);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeAppendRawMetaData(String txHex, String dataHex) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("txHex", txHex);
	...
	protected Object executeCreateRawSendFrom(String address, List<RawParam> rawParams, String[] data, String action)
		...
		if (rawParams == null || rawParams.isEmpty()) {
			throw new ShellChainException("rawParams", "rawParams is null or empty");
		}
	...
	protected Object executeCreateRawTransaction(List<TxIdVout> inputs, List<AddressBalanceAsset> addessAssets)
		...
		if (inputs == null || inputs.isEmpty()) {
			throw new ShellChainException("inputs", "inputs needed to create a RAW Transaction");
		}
		...
		if (addessAssets == null || addessAssets.isEmpty()) {
			throw new ShellChainException("Address Assets", "Address Assets needed to create a RAW Transaction");
		}
		for (AddressBalanceAsset addressAsset : addessAssets) {
			addressAsset.isFilled();
		}

		return execute(CommandEnum.CREATERAWTRANSACTION, GsonFormatters.formatJson(inputs), GsonFormatters.formatJson(addessAssets));
	}
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeDecodeRawTransaction(String hex) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("hex", hex);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGetRawChangeAddress() throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGetRawTransaction(String txid, int verbose) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeSendRawTransaction(String hexString) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("hexString", hexString);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeSignRawTransaction(String hexString) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("hexString", hexString);
