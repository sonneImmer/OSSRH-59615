...
public class QueryBuilderWalletTransaction extends QueryBuilderCommon {
	...
	protected Object executeGetAddressTransaction(	String address,
													String txid,
													boolean verbose) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGetTransaction(String txid, boolean includeWatchonly) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("txid", txid);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGetTxOut(String txid, int vout, boolean includemempool) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("txid", txid);
		ShellChainTestParameter.valueIsPositive("vout", vout);
	...
	protected Object executeListAddressTransactions(String address,
		...
		ShellChainTestParameter.valueIsNotNegative("skip", skip);
	...
	protected Object executeSendFromAddress(String fromAddress,
											String toAddress,
											List<BalanceAssetBase> assets) throws ShellChainException {
	...
	protected Object executeSendFromAddress(String fromAddress,
											String toAddress,
											double amount) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		ShellChainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		ShellChainTestParameter.valueIsPositive("amount", amount);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeSendToAddress(String address, List<BalanceAssetBase> assets) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("address", address);
		if (assets == null || assets.isEmpty()) {
			throw new ShellChainException("assets", "assets needed to be sent");
		}
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeSendToAddress(String address, double amount) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("address", address);
		ShellChainTestParameter.valueIsPositive("amount", amount);
	...
	protected Object executeSendWithMetaData(	String address,
												...
												String hexMetaData) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("address", address);
		ShellChainTestParameter.isNotNullOrEmpty("hexMetaData", hexMetaData);
		...
		for (BalanceAssetBase asset : assets) {
			asset.isFilled();
			simpleMap.put(asset.getName(),asset.getQty());
		}

		return execute(CommandEnum.SENDWITHMETADATA, address, simpleMap, hexMetaData);
	}
	...
	protected Object executeSendWithDataFrom(	String fromAddress,
												...
												String assetName,
												Integer assetValue,
												String metadata) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("fromAddress", fromAddress);
		ShellChainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		ShellChainTestParameter.isNotNullOrEmpty("metadata", metadata);
		ShellChainTestParameter.isNotNull("asset", assetName);
		ShellChainTestParameter.valueIsPositive("assetValue", assetValue);
	...
	protected Object executeRegisterTort(String toAddress, Map<String,Object> attributes) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		ShellChainTestParameter.isNotNullOrEmpty("tort_file_id", (String)attributes.get("tort_file_id"));
		ShellChainTestParameter.isNotNullOrEmpty("tort_file_hash", (String)attributes.get("tort_file_hash"));
		return execute(CommandEnum.REGISTERTORT, toAddress, attributes);
	}

	protected Object executeUpdateTort(String toAddress, String lastTxId, Map<String,Object> attributes) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("toAddress", toAddress);
		return execute(CommandEnum.UPDATETORT, toAddress, lastTxId, attributes);
	}
}
