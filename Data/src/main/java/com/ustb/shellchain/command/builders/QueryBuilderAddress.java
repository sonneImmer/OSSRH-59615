...
public class QueryBuilderAddress extends QueryBuilderCommon {
	 ...
	 */
	protected Object executeCreateKeyPairs(int numberOfPairs) throws ShellChainException {
		ShellChainTestParameter.valueIsPositive("number of pairs", numberOfPairs);
	...
	protected Object executeAddMultiSigAddress(	int numberOfSigRequired,
												String[] publicKeys) throws ShellChainException {
		ShellChainTestParameter.valueIsPositive("number of signature required", numberOfSigRequired);
		ShellChainTestParameter.isNotNullOrEmpty("publicKeys", publicKeys);
		ShellChainTestParameter.arrayNotContainNullOrEmptyValues("publicKeys", publicKeys);
		if (publicKeys.length >= numberOfSigRequired) {
			...
			throw new ShellChainException("number of signature", "is greater than the size of public keys");
		}
	}
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeCreateMultiSig(int numberOfSigRequired, String[] publicKeys) throws ShellChainException {

		ShellChainTestParameter.valueIsPositive("number of signature required", numberOfSigRequired);
		ShellChainTestParameter.isNotNullOrEmpty("public Keys", publicKeys);
		ShellChainTestParameter.arrayNotContainNullOrEmptyValues("public Keys", publicKeys);
		if (publicKeys.length >= numberOfSigRequired) {
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGetAddressBalances(String address) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGetAddresses(boolean verbose) throws ShellChainException {
	 ...
	 * @return Balances
	 */
	protected Object executeGetMultiBalances(String[] addresses, String[] assets) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("addresses", addresses);
		ShellChainTestParameter.arrayNotContainNullOrEmptyValues("addresses", addresses);
		ShellChainTestParameter.isNotNullOrEmpty("assets", assets);
		ShellChainTestParameter.arrayNotContainNullOrEmptyValues("assets", assets);
	 ...
	 * @return Balances
	 */
	protected Object executeGetMultiBalances(String[] addresses) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("addresses", addresses);
		ShellChainTestParameter.arrayNotContainNullOrEmptyValues("addresses", addresses);
		return execute(CommandEnum.GETMULTIBALANCES, formatJson(addresses));
	}

	protected Object executeGetMultiBalances(String address) throws ShellChainException {
		return execute(CommandEnum.GETMULTIBALANCES, address);
	}

	protected Object executeGetMultiBalances() throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeGetNewAddress() throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeImportAddress(String address, String label, boolean rescan) throws ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("address", address);
	 ...
	 * @throws ShellChainException
	 */
	protected Object executeValidateAddress(String address) throws ShellChainException, ShellChainException {
		ShellChainTestParameter.isNotNullOrEmpty("address", address);
		return execute(CommandEnum.VALIDATEADDRESS, address);
	}


	protected Object executeCreateEntity(	Integer type,String fromAddress,String toAddress) throws ShellChainException {
		ShellChainTestParameter.isNotNull("type", type);
		...
		if(toAddress!=null){
			...
			return execute(CommandEnum.CREATEENTITY, type,fromAddress,toAddress);
		}else{
			return execute(CommandEnum.CREATEENTITY, type,fromAddress);
		}
	}
}
