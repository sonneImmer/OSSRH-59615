...
import com.ustb.shellchain.command.builders.QueryBuilderGrant;
import com.ustb.shellchain.object.Address;
import com.ustb.shellchain.object.Permission;
import com.ustb.shellchain.object.formatters.GrantFormatter;
...
public class GrantCommand extends QueryBuilderGrant {
	 ...
	 * 
	 * Arguments: 1. "address(es)" (string, required) The shellchain addresses
	 ...
	 * @Deprecated
	 */
	public String grant(Address address, byte permissions) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String grant(Address address, int permissions) throws ShellChainException {
	 ...
	 * @Deprecated
	 */
	public String grant(String address, byte permissions) throws ShellChainException {
		Byte b = new Byte(permissions);
	 ...
	 * @throws ShellChainException
	 */
	public String grant(String address, int permissions) throws ShellChainException {
		String grant = "";
	 ...
	 * 2. "to-address(es)" (string, required) The shellchain addresses to grant
	 ...
	 * @Deprecated
	 */
	public String grantFrom(Address addressFrom, Address address, byte permissions) throws ShellChainException {
		Byte b = new Byte(permissions);
	 ...
	 * @throws ShellChainException
	 */
	public String grantFrom(Address addressFrom, Address address, int permissions) throws ShellChainException {
	 ...
	 * @Deprecated
	 */
	public String grantFrom(String addressFrom, String address, byte permissions) throws ShellChainException {
		Byte b = new Byte(permissions);
	 ...
	 * @throws ShellChainException
	 */
	public String grantFrom(String addressFrom, String address, int permissions) throws ShellChainException {
		String grant = "";
	 ...
	 * @throws ShellChainException
	 */
	public String grantWrite(Address address, String streamName) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String grantWrite(String address, String streamName) throws ShellChainException {
		String grantWrite = "";
	 ...
	 * @throws ShellChainException
	 */
	public String grantWriteFrom(Address addressFrom, Address address, String streamName) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String grantWriteFrom(String addressFrom, String address, String streamName) throws ShellChainException {
		String grantWrite = "";
	 ...
	 * @throws ShellChainException
	 */
	public List<Permission> listPermissions(byte permissions, Address address) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<Permission> listPermissions(int permissions, Address address) throws ShellChainException {
		return listPermissions(permissions, address, false);
	}
	 ...
	 * @throws ShellChainException
	 */
	public List<Permission> listPermissions(int permissions, String address) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<Permission> listPermissions(byte permissions, String address) throws ShellChainException {
		Address returnedAddress = new Address(address);
	 ...
	 * @throws ShellChainException
	 */
	public List<Permission> listPermissions(byte permissions) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<Permission> listPermissions(int permissions) throws ShellChainException {
		return listPermissions(permissions, (String) null, false);
	}
	 ...
	 * @throws ShellChainException
	 */
	public List<Permission> listPermissions() throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String revoke(Address address, byte permissions) throws ShellChainException {
		Byte b = new Byte(permissions);
	 ...
	 * @throws ShellChainException
	 */
	public String revoke(Address address, int permissions) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String revoke(String address, byte permissions) throws ShellChainException {
		Byte b = new Byte(permissions);
	 ...
	 * @throws ShellChainException
	 */
	public String revoke(String address, int permissions) throws ShellChainException {
		String revoke = "";
	 ...
	 * @throws ShellChainException
	 */
	public String revokeFrom(Address addressFrom, Address address, byte permissions) throws ShellChainException {
		Byte b = new Byte(permissions);
	 ...
	 * @throws ShellChainException
	 */
	public String revokeFrom(Address addressFrom, Address address, int permissions) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String revokeFrom(String addressFrom, String address, byte permissions) throws ShellChainException {
		Byte b = new Byte(permissions);
	 ...
	 * @throws ShellChainException
	 */
	public String revokeFrom(String addressFrom, String address, int permissions) throws ShellChainException {
		String revoke = "";
