...
import com.ustb.shellchain.command.builders.QueryBuilderWalletTransaction;
import com.ustb.shellchain.object.*;
import com.ustb.shellchain.object.formatters.TransactionFormatter;
import com.ustb.shellchain.object.formatters.TxOutFormatter;
import com.ustb.shellchain.object.formatters.WalletTransactionFormatter;
...
public class WalletTransactionCommand extends QueryBuilderWalletTransaction {
	 ...
	 */
	public TransactionWallet getAddressTransaction(String address, String txid, boolean verbose) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TransactionWallet getAddressTransaction(String address, String txid) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public Transaction getTransaction(String txid, boolean includeWatchonly) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public Transaction getTransaction(String txid) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TxOut getTxOut(String txid, int vout, boolean includemempool) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TxOut getTxOut(String txid, int vout) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TransactionWalletDetailed getWalletTransaction(String txid, boolean includeWatchOnly, boolean verbose) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TransactionWalletDetailed getWalletTransactionWithDetail(String txid) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public TransactionWallet getWalletTransactionWithoutDetail(String txid) throws ShellChainException {
	...
	public List<TransactionWallet> listAddressTransactions(String address, long count, long skip, boolean verbose) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<TransactionWallet> listAddressTransactions(String address, long count, long skip) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<TransactionWallet> listAddressTransactions(String address, long count) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<TransactionWallet> listAddressTransactions(String address) throws ShellChainException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<TransactionWalletDetailed> listWalletTransaction(long count, long skip, boolean includeWatchonly, boolean verbose) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<TransactionWallet> listWalletTransactionWithoutDetail(long count, long skip, boolean includeWatchonly, boolean verbose) throws ShellChainException {
		...
		List<TransactionWallet> listTransactionWallet = new ArrayList<TransactionWallet>(Arrays.asList(arrayTransactionWallet));
	 ...
	 * @throws ShellChainException
	 */
	public List<TransactionWallet> listWalletTransaction(long count, long skip, boolean includeWatchonly) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<TransactionWallet> listWalletTransaction(long count, long skip) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<TransactionWallet> listWalletTransaction(long count) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public List<TransactionWallet> listWalletTransaction() throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String sendFromAddress(String fromAddress, String toAddress, List<BalanceAssetBase> assets) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String sendToAddress(String address, List<BalanceAssetBase> assets) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String sendToAddress(String address, double amount) throws ShellChainException {
		String stringSendToAddress = "";
	 ...
	 * @throws ShellChainException
	 */
	public String sendWithMetaData(String address, List<BalanceAssetBase> assets, String hexMetaData) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String sendWithMetaData(String address, double amount, String hexMetaData) throws ShellChainException {
		String stringSendWithMetaData = "";
	 ...
	 * @throws ShellChainException
	 */
	public String sendWithMetaDataFrom(String fromAddress, String toAddress, List<BalanceAssetBase> assets, String hexMetaData) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public String sendWithMetaDataFrom(String fromAddress, String toAddress, double amount, String hexMetaData) throws ShellChainException {
		String stringSendWithMetaDataFrom = "";
	...
	public String sendWithDataFrom(String fromAddress, String toAddress, String assetName, Integer assetValue, String metadata) throws ShellChainException {
	...
	/**
	 * 发布创建侵权作品的交易
	 * @param attributes ，作品信息{tort_file_id,tort_file_hash,origin_file_id,time}
	 * @return
	 * @throws ShellChainException
	 */
	public String registerTort(String toAddress ,Map<String, Object> attributes) throws ShellChainException {
		String txResult="";
		Object objectRegisterTort = executeRegisterTort(toAddress, attributes);
		if (verifyInstance(objectRegisterTort, String.class)) {
			txResult = (String) objectRegisterTort;
		}
		return txResult;
	}
	 ...
	 * @throws ShellChainException
	 */
	public Object updateTort(String toAddress, String lastTxId, Map<String, Object> attributes) throws ShellChainException {
		String txResult = "";
		Object objectRegisterTort = executeUpdateTort(toAddress, lastTxId, attributes);
		if (verifyInstance(objectRegisterTort, String.class)) {
			txResult = (String)objectRegisterTort;
		}
		return txResult;
