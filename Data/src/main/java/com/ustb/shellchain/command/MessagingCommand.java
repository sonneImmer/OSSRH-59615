...
import com.ustb.shellchain.command.builders.QueryBuilderMessaging;
...
public class MessagingCommand extends QueryBuilderMessaging {
	 ...
	 */
	public final boolean verifyMessage(Address address, String signature, String message) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public final boolean verifyMessage(String address, String signature, String message) throws ShellChainException {
	...
	public final String signMessage(Address addressORPrivateKey, String message) throws ShellChainException {
	 ...
	 * @throws ShellChainException
	 */
	public final String signMessage(String addressORPrivateKey, String message) throws ShellChainException {
